...
export const THEME_PRESETS = [
    {
        ...
        inactiveMenuClass: 'text-slate-600 dark:text-slate-300 hover:bg-[#E7F7F2]/60 dark:hover:bg-[#008069]/15 hover:text-[#008069] dark:hover:text-[#25D366] hover:border-[#A2E2CD]/60 dark:hover:border-[#008069]/30 border border-transparent',
        ...
        inactiveSubmenuClass: 'text-slate-500 dark:text-slate-400 hover:bg-[#E7F7F2]/50 dark:hover:bg-[#008069]/15 hover:text-[#008069] dark:hover:text-[#25D366]',
