...
import { Layout, FileText, ArrowRight, Video } from 'lucide-react';
...
export default function CmsSubMenu({ isCollapsed }) {
    return (
        <div className="flex flex-col px-1">
            {/* <MenuItem to="landing" icon={Layout} label="Landing Page"  isCollapsed={isCollapsed} /> */}
            <MenuItem to="pages" icon={FileText} label="Static Pages"  isCollapsed={isCollapsed} />
            <MenuItem to="tutorials" icon={Video} label="Tutorials"  isCollapsed={isCollapsed} />
        </div>
    );
}
