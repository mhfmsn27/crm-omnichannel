...
const MenuItem = ({ to, icon: Icon, label, isNew, isHot , isCollapsed}) => (
    ...
    >
        ...
        <div className="flex items-center gap-2">
                ...
                {isHot && <span className="bg-red-100 text-red-600 text-[9px] px-1.5 py-0.5 rounded-full font-bold uppercase animate-pulse dark:bg-red-900/30 dark:text-red-400">HOT</span>}
            </div>
        )}
        </div>
  ...
  return (
    <div className="flex flex-col">
        <div className="mb-2 px-1">
            ...
            <MenuItem to="warmer" icon={Flame} label="WA Warmer"  isCollapsed={isCollapsed} />
            <MenuItem to="check-number" icon={ShieldCheck} label="Check Number"  isCollapsed={isCollapsed} />
            <MenuItem to="group-extractor" icon={UserPlus} label="Group Extractor"  isCollapsed={isCollapsed} />
        </div>
        ...
        <div className="mt-2 px-1 border-t border-gray-200 dark:border-slate-700 pt-4">
            ...
            <MenuItem to="chat-form" icon={FileText} label="Chat Form" isHot  isCollapsed={isCollapsed} />
            <MenuItem to="scraper" icon={MapPin} label="GMaps Scraper"  isCollapsed={isCollapsed} />
            <MenuItem to="follow-up" icon={Clock} label="Auto Follow-up"  isCollapsed={isCollapsed} />
            <MenuItem to="tutorial" icon={HelpCircle} label="Tutorials"  isCollapsed={isCollapsed} />
        </div>
    </div>
  );
}
