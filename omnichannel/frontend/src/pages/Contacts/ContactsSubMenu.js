...
const MenuItem = ({ to, icon: Icon, label, isNew, isCollapsed }) => (
    ...
    >
        <div className={`flex items-center gap-3 w-full ${isCollapsed ? 'justify-center' : ''}`}>
            <div className="p-1.5 rounded-md transition-colors bg-gray-100 text-gray-500 group-hover:bg-orange-100 group-hover:text-orange-600 dark:bg-slate-800 dark:text-slate-400">
