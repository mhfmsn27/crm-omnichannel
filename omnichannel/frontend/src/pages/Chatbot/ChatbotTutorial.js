...
export default function ChatbotTutorial() {
    ...
    const fetchTutorial = async () => {
        try {
            // Convention: Tutorial for chatbot module has slug 'tutorial-chatbot'
            const res = await axios.get('/api/public/pages/tutorial-chatbot');
    ...
    if (!data) {
        return (
            <div className="p-8 h-full flex flex-col items-center justify-center text-gray-400 bg-gray-50 rounded-xl m-4">
                ...
                <p>Admin belum membuat konten tutorial untuk modul Chatbot.</p>
            </div>
        );
    }
