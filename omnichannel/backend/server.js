...
import warmerRoutes from './src/routes/warmerRoutes.js';
...
import attributionRoutes from './src/routes/attributionRoutes.js';
import gamificationRoutes from './src/routes/gamificationRoutes.js';
import csatRoutes from './src/routes/csatRoutes.js';
...
api.use('/app/tools', toolRoutes);
api.use('/app/warmer', warmerRoutes);
api.use('/app/followups', followupRoutes);
api.use('/app/forms', formRoutes);
api.use('/app/chatbot', chatbotRoutes);
api.use('/app/flows', flowRoutes);
api.use('/app/tasks', taskRoutes);
api.use('/app/tickets', ticketRoutes);
...
api.use('/app', crmRoutes); // For /sales-visits, /calls, etc. fallback
